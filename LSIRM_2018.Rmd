...
#### Assignment 1
__Combine `age`, `gender`   and `lucky`  into one matrix called `matrix1   with 3 columns and n rows using the `matrix()`   command, the `ncol=` and/or the `nrow=`  arguments.__
